...
Run the Sql Query From this file: database/shopping-cart.sql
...
Step 2: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: https://github.com/ashish01760/eCommerce.git> Select master Branch > Next > Next > Finish.
...
Step 8: Check Running The Site At http://localhost:8123/eCommerce/

Step 9: [To Change the Port, if getting error like 'port already in use'] Open The Server Tab > Double Click On Tomcat Server > Ports > Change The Port Number For Http/1.1 To 8123 > Close And Save. Now Start and you can access the project on http://localhost:8123/eCommerce/
